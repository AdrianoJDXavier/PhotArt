...
@NamedQueries({
    ...
    @NamedQuery(name = "Avaliacao.findByAutor", query = "SELECT a FROM Avaliacao a WHERE a.autor = :autor"),
...
public class Avaliacao implements Serializable {
    ...
    public Avaliacao(String titulo, String conteudo, String autor, short nota) {
        this.titulo = titulo;
    ...
    public String toString() {
        return "photArt.modell.Avaliacao[ id=" + id + " ]";
    }
